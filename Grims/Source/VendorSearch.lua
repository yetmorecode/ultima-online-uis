...
function VendorSearch.Initialize()
	...
	if(VendorSearch.QuickSearch) then
		Debug.Print("quicksearch")
		--VendorSearch.ClearAll()
		TextEditBoxSetText(VendorSearch.WindowName .. "ItemNameText", towstring(VendorSearch.QuickSearch))
		TextEditBoxSetText(GumpData.Gumps[999112].TextEntry[1], towstring(VendorSearch.QuickSearch))
		VendorSearch.QuickSearch = nil
		VendorSearch.SearchThis()
