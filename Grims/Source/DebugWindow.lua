...
function DebugWindow.Initialize()
    ...
    LogDisplaySetFilterColor("DebugWindowText", "UiLog", LuaLog.SYSTEM, 0, 0, 0 ) -- Magenta
    LogDisplaySetFilterColor("DebugWindowText", "UiLog", LuaLog.ERROR, 0, 0, 0 ) -- Red
    LogDisplaySetFilterColor("DebugWindowText", "UiLog", LuaLog.DEBUG, 0, 0, 0 ) -- Yellow
    LogDisplaySetFilterColor("DebugWindowText", "UiLog", LuaLog.FUNCTION, 0, 0, 0 ) -- Green
    LogDisplaySetFilterColor("DebugWindowText", "UiLog", LuaLog.WARNING, 0, 0, 0 ) -- Green
	-- Loading, functions, something else...
	LogDisplaySetFilterColor("DebugWindowText", "UiLog", 5, 0, 0, 0 ) -- Green
	LogDisplaySetFilterColor("DebugWindowText", "UiLog", 6, 0, 0, 0 ) -- Green
	LogDisplaySetFilterColor("DebugWindowText", "UiLog", 7, 0, 0, 0 ) -- Green
	...
	LabelSetText("DebugWindowOptionsChrome_UO_TitleBar_WindowTitle", L"Options")
