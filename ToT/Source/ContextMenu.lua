...
function ContextMenu.Show()
	...
	WindowSetOffsetFromParent("ContextMenu", (cmWindowX - 320) * scaleFactor, (cmWindowY - 240) * scaleFactor)
	--ContextMenu.Hide()
	--WindowSetShowing("ContextMenu", false)
	
	-- ToT: Automatically dismiss attendant and hide context menu!
	WindowData.ContextMenu.returnCode = 623
	BroadcastEvent(SystemData.Events.CONTEXT_MENU_SELECTED)
end
