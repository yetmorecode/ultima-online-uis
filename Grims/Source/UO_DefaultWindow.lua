...
function UO_DefaultWindow.Initialize()
	WindowSetAlpha(SystemData.ActiveWindow.name.."_UO_DefaultWindowBackground", 0.95);
end
...
function UO_DefaultWindow.CloseTooltip()
	...
	--WindowSetTintColor(SystemData.ActiveWindow.name, 255, 0,0)
...
function UO_DefaultWindow.Hover()
Debug.Print(SystemData.ActiveWindow.name)
	WindowSetTintColor(SystemData.ActiveWindow.name .. "Icon", 140, 180, 200)
end

function UO_DefaultWindow.HoverEnd()
Debug.Print(SystemData.ActiveWindow.name)
	WindowSetTintColor(SystemData.ActiveWindow.name .. "Icon", 255, 255, 255)
end