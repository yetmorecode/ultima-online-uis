...
function RaceChangeWindow.Initialize()
	...
	--Debug.PrintToDebugConsole(L"Gender= "..towstring(tostring( WindowData.RaceChange.Gender)))
	--Debug.PrintToDebugConsole(L"Race= "..towstring(tostring( WindowData.RaceChange.Race)))
	--Debug.PrintToDebugConsole(L"win name= "..towstring(SystemData.ActiveWindow.name))
...
function RaceChangeWindow.HandleOkButton()
	--Debug.PrintToDebugConsole(L"RaceChangeWindow.HandleOkButton() - skin color =  "..towstring(tostring(RCWskinColor)))
	--Debug.PrintToDebugConsole(L"RaceChangeWindow.HandleOkButton() - RCWhairStyle =  "..towstring(tostring(RCWhairStyle)))
	--Debug.PrintToDebugConsole(L"RaceChangeWindow.HandleOkButton() - RCWhairColor =  "..towstring(tostring(RCWhairColor)))
	--Debug.PrintToDebugConsole(L"RaceChangeWindow.HandleOkButton() - RCWfacialHairStyle =  "..towstring(tostring(RCWfacialHairStyle)))
	--Debug.PrintToDebugConsole(L"RaceChangeWindow.HandleOkButton() - RCWfacialHairColor =  "..towstring(tostring(RCWfacialHairColor)))
...
function RaceChangeWindow.updateWearableItemIndex(appearanceTable, appearanceLabel, appearanceStyle, increment)
    ...
    local numStyles = #appearanceTable
    local WindowName = RaceChangeWindow.WindowName
    
	for i = 1, #appearanceTable do
		local v = appearanceTable[i]
