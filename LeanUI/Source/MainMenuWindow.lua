...
MainMenuWindow.TID.AGENTS        = 1154762
...
function MainMenuWindow.Initialize()
	...
	LabelSetText("MainMenuWindowWindowsItemText", L"Windows" )
...
function MainMenuWindow.OnToggleWindows()
	ToggleWindowByName( "LeanWindowOverview", "", MainMenuWindow.OnToggleWindows )	
	WindowSetShowing("MainMenuWindow",false)
end