...
StaticTextWindow.AlphaStart = 0.6
...
StaticTextWindow.OnTextArrivedHandler = {}

function StaticTextWindow.AddTextArrivedHandler(handler)
	local sz = table.getn(StaticTextWindow.OnTextArrivedHandler)
	StaticTextWindow.OnTextArrivedHandler[sz+1] = handler
end

function StaticTextWindow.NotifyTextArrivedHandler(text)
	for key,value in pairs(StaticTextWindow.OnTextArrivedHandler) do
		handler = StaticTextWindow.OnTextArrivedHandler[key]
		pcall(handler)
	end
end
...
function StaticTextWindow.CreateWindow()
	...
	StaticTextWindow.NotifyTextArrivedHandler(name)
	...
	WindowSetAlpha(labelName, StaticTextWindow.AlphaStart)
