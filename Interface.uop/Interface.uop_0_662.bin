...
function StatusWindow.Initialize(reinit)
	...
	WindowUtils.RestoreWindowPosition("AdvancedStatusWindowHP")
	WindowUtils.RestoreWindowPosition("AdvancedStatusWindowMANA")
	WindowUtils.RestoreWindowPosition("AdvancedStatusWindowSTAM")
	WindowUtils.LoadScale("StatusWindow")
	WindowUtils.LoadScale("AdvancedStatusWindowHP")
	WindowUtils.LoadScale("AdvancedStatusWindowMANA")
	WindowUtils.LoadScale("AdvancedStatusWindowSTAM")
	...
	WindowSetTintColor("AdvancedStatusWindowSTAMLagBar", 0, 255, 0)
	
	WindowSetAlpha("AdvancedStatusWindowSTAMLagBar", 0.8)
	...
	elseif (not DoesWindowNameExist("GlowingEffectHealth") and Interface.StatusWindowStyle == 1) then		
		if WindowData.MobileName[WindowData.PlayerStatus.PlayerId] then
			noto = tonumber(WindowData.MobileName[WindowData.PlayerStatus.PlayerId].Notoriety+1)
		end				
		CreateWindowFromTemplate("GlowingEffectHealth", "StatusTEXTs", "AdvancedStatusWindowSTAM")
		CreateWindowFromTemplate("GlowingEffectAnimHealth", "StatusGlowingEffect", "GlowingEffectHealth")
		WindowClearAnchors("GlowingEffectHealth")
		WindowAddAnchor("GlowingEffectHealth", "center", "AdvancedStatusWindowSTAMPortraitBg", "center", 14, 12)
		WindowSetScale("GlowingEffectHealth", WindowGetScale("AdvancedStatusWindowSTAM"))		
		AnimatedImageStartAnimation( "GlowingEffectAnimHealth", 1, true, false, 0.0 )  		
		AnimatedImageSetPlaySpeed( "GlowingEffectAnimHealth", 10)
		WindowSetTintColor("GlowingEffectAnimHealth",StatusWindow.TextColors[noto].r,StatusWindow.TextColors[noto].g,StatusWindow.TextColors[noto].b)
	end
	...
	ButtonSetTexture("AdvancedStatusWindowSTAMMenu", InterfaceCore.ButtonStates.STATE_NORMAL, "arrowdown", 0, 0)
	ButtonSetTexture("AdvancedStatusWindowSTAMMenu", InterfaceCore.ButtonStates.STATE_NORMAL_HIGHLITE, "arrowdown", 22, 0)
	ButtonSetTexture("AdvancedStatusWindowSTAMMenu", InterfaceCore.ButtonStates.STATE_PRESSED, "arrowdown", 22, 0) 
	ButtonSetTexture("AdvancedStatusWindowSTAMMenu", InterfaceCore.ButtonStates.STATE_PRESSED_HIGHLITE, "arrowdown", 22, 0)
...
function StatusWindow.LockHP()
	...
	local this = "AdvancedStatusWindowHP"
	local texture = "UO_Core"
	if ( StatusWindow.HPLocked  ) then		
		ButtonSetTexture(this.."Lock", InterfaceCore.ButtonStates.STATE_NORMAL, texture, 69,341)
		ButtonSetTexture(this.."Lock",InterfaceCore.ButtonStates.STATE_NORMAL_HIGHLITE, texture, 92,341)
...
function StatusWindow.LockMANA()
	...
	local this = "AdvancedStatusWindowMANA"
	local texture = "UO_Core"
	if ( StatusWindow.MANALocked ) then		
		ButtonSetTexture(this.."Lock", InterfaceCore.ButtonStates.STATE_NORMAL, texture, 69,341)
		ButtonSetTexture(this.."Lock",InterfaceCore.ButtonStates.STATE_NORMAL_HIGHLITE, texture, 92,341)
...
function StatusWindow.LockSTAM()
	...
	local this = "AdvancedStatusWindowSTAM"
	local texture = "UO_Core"
	if ( StatusWindow.STAMLocked ) then		
		ButtonSetTexture(this.."Lock", InterfaceCore.ButtonStates.STATE_NORMAL, texture, 69,341)
		ButtonSetTexture(this.."Lock",InterfaceCore.ButtonStates.STATE_NORMAL_HIGHLITE, texture, 92,341)
...
function StatusWindow.UpdateLatency()
	...
	if Interface.StatusWindowStyle == 0 then
		local w, h = WindowGetDimensions("StatusWindowLagBar")
	...
	elseif Interface.StatusWindowStyle == 1 then
		local w, h = WindowGetDimensions("AdvancedStatusWindowSTAMLagBar")
		local hue = {r=0,g=255,b=0}
		if Interface.Latency.lag < 250 then
			w = 148
		elseif Interface.Latency.lag < 650 then
		...
		WindowSetTintColor("AdvancedStatusWindowSTAMLagBar", hue.r, hue.g, hue.b)
		WindowSetDimensions("AdvancedStatusWindowSTAMLagBar", w, h)
...
function StatusWindow.UpdateStatus()
	...
	elseif Interface.StatusWindowStyle == 1 then
		StatusBarSetMaximumValue( "AdvancedStatusWindowSTAMFill", WindowData.PlayerStatus.MaxStamina )
		StatusBarSetCurrentValue( "AdvancedStatusWindowSTAMFill", WindowData.PlayerStatus.CurrentStamina )
		StatusWindow.SetMana( WindowData.PlayerStatus.CurrentMana, WindowData.PlayerStatus.MaxMana )
		HealthBarColor.UpdateHealthBarColor("AdvancedStatusWindowHPFill", WindowData.PlayerStatus.VisualStateId)
		StatusWindow.SetHealth( WindowData.PlayerStatus.CurrentHealth, WindowData.PlayerStatus.MaxHealth )
		
		WindowSetTintColor( "AdvancedStatusWindowMANAFill", 0, 0, 255 )
		WindowSetDimensions( "AdvancedStatusWindowMANAFill", StatusWindow.MPWidth, StatusWindow.LastMPHeight+1 )
		WindowSetDimensions( "AdvancedStatusWindowMANAFill", StatusWindow.MPWidth, StatusWindow.LastMPHeight )
	...
	if( SystemData.PaperdollTexture[WindowData.PlayerStatus.PlayerId] ~= nil) then
		...
		if IsPlayerDead() then
			if Interface.StatusWindowStyle == 0 then
				...
				WindowSetShowing("AdvancedStatusWindowSTAMPortrait", false)
				WindowSetShowing("AdvancedStatusWindowSTAMDead", true)
				CircleImageSetTexture("AdvancedStatusWindowSTAMDead","dead",-32,-30)
			end
		elseif mobileData then
			...
			if Interface.StatusWindowStyle == 0 then
				...
				WindowSetShowing("AdvancedStatusWindowSTAMPortrait", true)
				WindowSetShowing("AdvancedStatusWindowSTAMDead", false)
				CircleImageSetTexture("AdvancedStatusWindowSTAMPortrait", "",0,0)
				if mobileData.Gender == 1 then
					if mobileData.Race == PaperdollWindow.GARGOYLE then
						CircleImageSetTexture("AdvancedStatusWindowSTAMPortrait", "paperdoll_texture"..WindowData.PlayerStatus.PlayerId, x - textureData.xOffset + 8, y - textureData.yOffset - 22 )
						CircleImageSetTextureScale("AdvancedStatusWindowSTAMPortrait", InterfaceCore.scale * scale - 0.2)
					else
						CircleImageSetTexture("AdvancedStatusWindowSTAMPortrait", "paperdoll_texture"..WindowData.PlayerStatus.PlayerId, x - textureData.xOffset + 8, y - textureData.yOffset - 18 )
						CircleImageSetTextureScale("AdvancedStatusWindowSTAMPortrait", InterfaceCore.scale * scale)
					end
				else
					if mobileData.Race == PaperdollWindow.ELF then
						CircleImageSetTexture("AdvancedStatusWindowSTAMPortrait", "paperdoll_texture"..WindowData.PlayerStatus.PlayerId, x - textureData.xOffset - 3, y - textureData.yOffset - 5 )
						CircleImageSetTextureScale("AdvancedStatusWindowSTAMPortrait", InterfaceCore.scale * scale - 0.1)
					else
						CircleImageSetTexture("AdvancedStatusWindowSTAMPortrait", "paperdoll_texture"..WindowData.PlayerStatus.PlayerId, x - textureData.xOffset - 3, y - textureData.yOffset - 5 )
						CircleImageSetTextureScale("AdvancedStatusWindowSTAMPortrait", InterfaceCore.scale * scale)
					end
...
function StatusWindow.SetMana( current, maximum )
    ...
    if height ~= StatusWindow.LastMPHeight then
        ...
        WindowSetDimensions( "AdvancedStatusWindowMANAFill", StatusWindow.MPWidth, height )
    end
end
...
function StatusWindow.SetHealth( current, maximum )
    ...
    if height ~= StatusWindow.LastHPHeight then
        ...
        WindowSetDimensions( "AdvancedStatusWindowHPFill", StatusWindow.HPWidth, height )
    end
end

function StatusWindow.ChangeStyle( style )
	if Interface.StatusWindowStyle ~= style then
		Interface.StatusWindowStyle = style
		Interface.SaveNumber("StatusWindowStyle", Interface.StatusWindowStyle)
	end
	WindowSetShowing( "AdvancedStatusWindowHP",  Interface.StatusWindowStyle == 1 )
	WindowSetShowing( "AdvancedStatusWindowMANA",  Interface.StatusWindowStyle == 1 )
	WindowSetShowing( "AdvancedStatusWindowSTAM", Interface.StatusWindowStyle  == 1 )
	WindowSetShowing( "StatusWindow",  Interface.StatusWindowStyle  == 0 )
...
function StatusWindow.ToggleButtons()
	...
	WindowSetShowing("AdvancedStatusWindowSTAMGuardsButton", Interface.StatusButtons)
	WindowSetShowing("AdvancedStatusWindowSTAMMenu", Interface.StatusButtons)
	WindowSetShowing("AdvancedStatusWindowSTAMRedButton", Interface.StatusButtons)
	WindowSetShowing("AdvancedStatusWindowSTAMGreenButton", Interface.StatusButtons)
	WindowSetShowing("AdvancedStatusWindowSTAMBlueButton", Interface.StatusButtons)
end