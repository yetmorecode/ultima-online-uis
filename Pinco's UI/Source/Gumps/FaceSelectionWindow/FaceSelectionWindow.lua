...
function FaceSelectionWindow.Initialize()
	...
	--Debug.PrintToDebugConsole(L"FaceSelectionWindow.Initialize: maxFaceTypes = "..towstring(tostring(FaceSelectionWindow.maxFaceTypes)))
	...
	FaceSelectionWindow.paperdollId = GetPlayerID()
	FaceSelectionWindow.paperdollWindowName = "PaperdollWindow"..FaceSelectionWindow.paperdollId
	
	if (not(DoesWindowExist(FaceSelectionWindow.paperdollWindowName))) then
...
function FaceSelectionWindow.ToggleFaceUp()
	...
	--Debug.PrintToDebugConsole(L"FaceSelectionWindow.ToggleFaceUp: FaceSelectionWindow.FaceIndex = "..towstring(tostring(FaceSelectionWindow.FaceIndex)))
...
function FaceSelectionWindow.ToggleFaceDown()
	...
	--Debug.PrintToDebugConsole(L"FaceSelectionWindow.ToggleFaceDown: FaceSelectionWindow.FaceIndex = "..towstring(tostring(FaceSelectionWindow.FaceIndex)))
...
function FaceSelectionWindow.createWearableTable(CSVTable)
	local wearableTable = {}
	local numWearables =  #CSVTable

	--Debug.PrintToDebugConsole(L"FaceSelectionWindow.createWearableTable: numWearables = "..towstring(tostring(numWearables)))
	...
	for i = 1,numWearables do
		...
		if not ((CSVTable[i].TileArtId == 0) and (CSVTable[i].StringId == 0))  then
			--Debug.PrintToDebugConsole(L"FaceSelectionWindow.createWearableTable: i = "..towstring(tostring(i)))
			--Debug.PrintToDebugConsole(L"FaceSelectionWindow.createWearableTable: CSVTable[i].Entitlement = "..towstring(tostring(CSVTable[i].Entitlement)))
			--Debug.PrintToDebugConsole(L"FaceSelectionWindow.createWearableTable: HasEntitlement(tonumber(CSVTable[i].Entitlement)) = "..towstring(tostring(HasEntitlement(tonumber(CSVTable[i].Entitlement)))))
