...
function ChatSettings.SetupChannels()
    ...
    ChatSettings.Channels[ SystemData.ChatLogFilters.CUSTOM ]        = ChatChannel( L"Chat (Global)",  SystemData.ChatLogFilters.CUSTOM,             "Chat",     true,           true,                false,		ChannelColor(102, 178, 255),     SystemData.ChatLogFilters.CUSTOM,       L"/chat" )
