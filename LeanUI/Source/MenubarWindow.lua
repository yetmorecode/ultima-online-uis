...
function MenuBarWindow.Initialize()
	...
	WindowSetAlpha("MenuBarWindow", 1)
	MenuBarWindow.SetWindowState(SystemData.Settings.Interface.menuMode)
	
	LabelSetText("MenuBarWindowGeoData", L"X: ---- Y: ---- Z: ---- (----:----)")
end
...
function MenuBarWindow.Update(timePassed)
	local text = "X: "..WindowData.PlayerLocation.x.." Y: "..WindowData.PlayerLocation.y.." Z: "..WindowData.PlayerLocation.z
	text = text.." ("..SystemData.MousePosition.x..":"..SystemData.MousePosition.y..")"
	text = StringToWString(text)
	
	LabelSetText("MenuBarWindowGeoData", text)
end
